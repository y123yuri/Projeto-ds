...
urlpatterns = [
    ...
    path('login/esqueceu/nova-senha/<uidb64>/<str:token>/', views.novaSenha, name="novaSenha"),#nopva senha
    ...
    path('excluido/<str:username>/', views.deletar_usuario, name="excluir_usuario")
